...
@Table(name = "Serveralarm")
public class Serveralarm implements Serializable {
    /**
     * 主键guid
     */
    @Id
    ...
    /**
     * 告警类型1网络中断,2内存使用率过高,3网口异常,4 CPU使用率过高,5 CPU温度过高,6分区空间使用率过高
     */
     ...
     * This field corresponds to the database table serveralarm
     *
     * @mbg.generated Wed Aug 12 10:24:35 CST 2020
     */
