...
@Table(name = "Ivsalarm")
public class Ivsalarm implements Serializable {
    /**
     * 主键guid
     */
    @Id
    ...
    /**
     * 告警类型 1移动侦测,2 入侵检测,3逆行检测,4遗留物检测，5.人群异常行为检测
     */
     ...
     * This field corresponds to the database table ivsalarm
     *
     * @mbg.generated Wed Aug 12 10:24:19 CST 2020
     */
