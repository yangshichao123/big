...
@Table(name = "new_snow_alarm")
public class NewSnowAlarm implements Serializable {
    /**
     * 
     */
    @Id
     ...
     * 
     */
    private String snowdepthactual;

    /**
     * 
     */
    private String snowdepthbenchmark;
     ...
     * This field corresponds to the database table new_snow_alarm
     *
     * @mbg.generated Wed Oct 28 09:12:09 CST 2020
     */
    ...
    public String getSnowdepthactual() {
        return snowdepthactual;
    }

    public void setSnowdepthactual(String snowdepthactual) {
        this.snowdepthactual = snowdepthactual == null ? null : snowdepthactual.trim();
    }

    public String getSnowdepthbenchmark() {
        return snowdepthbenchmark;
    }

    public void setSnowdepthbenchmark(String snowdepthbenchmark) {
        this.snowdepthbenchmark = snowdepthbenchmark == null ? null : snowdepthbenchmark.trim();
    }
    ...
    public String toString() {
        ...
        sb.append(", snowdepthactual=").append(snowdepthactual);
        sb.append(", snowdepthbenchmark=").append(snowdepthbenchmark);
