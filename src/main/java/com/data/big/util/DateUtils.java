...
public class DateUtils {
    ...
    public static String getDate(String pattern) {
        return DateFormatHelper.date2String(new Date(), pattern);
    }
    ...
    public static String getDate(Date date, String pattern) {
        return DateFormatHelper.date2String(date, pattern);
    }
    ...
    public static String formatDate(Date date, Object... pattern) {
        ...
        if (pattern != null && pattern.length > 0) {
            formatDate = DateFormatHelper.date2String(date, pattern[0].toString());
        } else {
            formatDate = DateFormatHelper.date2String(date, DateUtils.DATE_FORMAT);
        }
        return formatDate;
    }
    ...
    public static Date parseDate(Object str, String pattern) {
        ...
        return DateFormatHelper.String2Date(str.toString(), pattern);
    }
    ...
    public static String getSpecifiedDayAfter(String specifiedDay, int num) {
        Date specifiedDate = parseDate(specifiedDay, "yyyy-MM-dd HH:mm:ss");
    ...
    public static int getMonthsBetween(String startDate, String endDate) {
        ...
        c1.setTime(DateUtils.parseDate(startDate, "yyyy-MM-dd"));
        c2.setTime(DateUtils.parseDate(endDate, "yyyy-MM-dd"));
     ...
     * 获取当前时间前几天得日期字符串
     *
     * @param i 前几天  "yyyy-MM-dd"
     * @return
     */
    public static String getBeforeDate(int i, String format) {
        Date date = new Date();
        Calendar calendar = Calendar.getInstance();
        calendar.setTime(date);
        calendar.add(Calendar.DAY_OF_MONTH, -i);
        date = (Date) calendar.getTime();
        String str = DateFormatHelper.date2String(date, format);
        return str;
    }
     ...
     * 获取当前时间前几小时得日期字符串
     *
     * @param i 前几小时  "yyyy-MM-dd HH"
     * @return
     */
    public static String getBeforeDateTime(int i, String format) {
        Date date = new Date();
        Calendar calendar = Calendar.getInstance();
        calendar.setTime(date);
