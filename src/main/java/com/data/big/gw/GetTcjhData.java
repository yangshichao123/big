...
@XmlRootElement(name = "getTcjhData")
public class GetTcjhData {

    @XmlElementRef(name = "temp", namespace = "http://services.itcmor.com", type = JAXBElement.class, required = false)
