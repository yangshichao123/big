...
public class Controller {
   ...
   /* @RequestMapping("/getGWConn")
     ...
     * @return
     */
    @RequestMapping("/addTaskDoor")
    public Map<String,Object> addTaskDoor() {
        return service.addTaskDoor();
    }
     ...
     * @return
     */
    @RequestMapping("/findWxjh")
    public Message findWxjh(Wxjh wxjh) {
        return service.findWxjh(wxjh);
    }
     ...
     * @return
     */
    @RequestMapping("/findSgjh")
    public Message findSgjh(Sgjh sgjh) {
        return service.findSgjh(sgjh);
    }
